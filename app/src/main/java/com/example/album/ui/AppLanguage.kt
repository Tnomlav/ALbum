...
private val APP_ENGLISH = mapOf(
    ...
    "屏蔽 R-18 图片" to "Hide R-18 pictures",
    "隐藏归档时写入 R-18 tag 的图片" to "Hide pictures tagged R-18 while archiving",
    "手势提示浮层" to "Gesture hint overlay",
    "手势操作时显示中间提示" to "Show the centre hint while gesturing",
