...
仓库内本地签名构建 `app/release/app-release.apk` 为 `1.1.60`（arm64-v8a 分包，其余架构见构建输出目录），仅用于交付前验证，不代表已创建 GitHub Release。其 SHA-256 为：

```text
11FA4D1F2E2067F5CE8A01D10411AC524E60240764354ADA1507FDF34A999498
```
